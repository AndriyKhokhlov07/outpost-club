...
<input type=hidden name="session_id" value="{$smarty.session.id}">
	...
	<div class=block>
		...
		<a href='http://backendcms.ru/check?domain={$smarty.server.HTTP_HOST|escape}'>Проверить лицензию</a>
		</div>
	</div>
...
<textarea style='width:420px; height:250px;'>Настоящее пользовательское соглашение (далее — Соглашение) является юридическим соглашением между Пользователем системы управления сайтами «Backend» (далее — Продуктом) и Пикусовым Д. С. (далее — Автором). 
...
Официальный сайт Продукта: backendcms.ru
</textarea>
		</div> 
	</div>
