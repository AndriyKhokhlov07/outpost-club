...
<div id="pagination">
	...
	{if $show_all != 'hide'}
		<a href="{url page=all}">show all</a>
	{/if}
	{if $current_page>1}<a id="PrevLink" href="{url page=$current_page-1}">←prev</a>{/if}
	{if $current_page<$pages_count}<a id="NextLink" href="{url page=$current_page+1}">next→</a>{/if}	
