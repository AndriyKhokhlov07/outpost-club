{capture name=tabs}
	<li class="active"><a href="index.php?module=ThemeAdmin">Theme</a></li>
...
<div id="header">
<h1 class="{if $theme->locked}locked{/if}">Current theme is {$theme->name}</h1>
<a class="add" href="#">Duplicate {$settings->theme} theme</a>
</div>

{if $message_error}
<!-- Системное сообщение -->
<div class="message message_error">
	<span class="text">{if $message_error == 'permissions'}Set writable permissions to the folder {$themes_dir}
	{elseif $message_error == 'name_exists'}Theme с таким именем уже существует
